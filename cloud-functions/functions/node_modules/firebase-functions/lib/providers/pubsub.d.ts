...
/** Handle events on a Cloud Pub/Sub title. */
export declare function title(title: string): TopicBuilder;
/** Builder used to create Cloud Functions for Google Pub/Sub topics. */
export declare class TopicBuilder {
    private resource;
    /** Handle a Pub/Sub message that was published to a Cloud Pub/Sub title */
